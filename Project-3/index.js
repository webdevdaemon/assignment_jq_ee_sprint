...
// function CreateState(obj) { for (let prop in obj) {this[prop] = obj[prop];} };
// let game = new CreateState(INIT_STATE);
$(document).ready(function() {
  $(document).on("click", "div, span", function(e) {e.preventDefault(); e.stopPropagation(); console.log({the_state});})
